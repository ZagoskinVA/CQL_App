...
public abstract class ColimSchExp extends Exp<ColimitSchema<String>> {
  ...
  public static interface ColimSchExpCoVisitor<R, P, E extends Exception> {
    ...
    public abstract ColimSchExpSimplify visitColimSchExpSimplify(P params, R exp) throws E;

    public abstract ColimSchExpPseudo visitColimSchExpPseudo(P params, R exp) throws E;
  }
  ...
  public static interface ColimSchExpVisitor<R, P, E extends Exception> {
    ...
    public abstract R visit(P params, ColimSchExpSimplify exp) throws E;
	...
	public abstract R visit(P param, ColimSchExpPseudo colimSchExpPseudo) throws E;
  }
