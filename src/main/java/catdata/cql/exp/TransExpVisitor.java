...
import com.example.program.TransExpStream;
...
public interface TransExpVisitor<R, P, E extends Exception> {
	public <Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> R visit(P params, TransExpCoEval<Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> exp)
			throws E;
	...
	public <Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> R visit(P params, TransExpDelta<Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> exp)
			throws E;

	public <Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> R visit(P params, TransExpDistinct<Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> exp)
			throws E;

	public <Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> R visit(P params, TransExpEval<Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> exp)
			throws E;

	public <Gen, Sk, X, Y> R visit(P params, TransExpId<Gen, Sk, X, Y> exp) throws E;

	public <Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> R visit(P params, TransExpLit<Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> exp)
			throws E;

	public <Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> R visit(P params, TransExpSigma<Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> exp)
			throws E;
	...
	public <X1, Y1, X2, Y2> R visit(P params, TransExpCsv<X1, Y1, X2, Y2> exp) throws E; public <X1, Y1, X2, Y2> R visit(P params, TransExpStream<X1, Y1, X2, Y2> exp) throws E;
	...
	public <Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> R visit(P params, TransExpPi<Gen1, Sk1, Gen2, Sk2, X1, Y1, X2, Y2> transExpPi)
			throws E;

	public R visit(P params, TransExpFrozen transExpFrozen);

	public <N, Gen, Sk, X, Y> R visit(P params, TransExpChaseReturn<N, Gen, Sk, X, Y> transExpChaseReturn);
