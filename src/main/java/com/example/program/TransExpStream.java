...
import catdata.cql.exp.InstExp;
import catdata.cql.exp.InstExpImport;
import catdata.cql.exp.Sym;
import catdata.cql.exp.TransExpImport;
import catdata.cql.exp.TransExpVisitor;
import catdata.cql.AqlOptions.AqlOption;
import gnu.trove.map.hash.THashMap;

public class TransExpStream<X1, Y1, X2, Y2>
    extends TransExpImport<String, String, String, String, X1, Y1, X2, Y2, Map<String, List<String[]>>> {

  public TransExpStream(InstExp<String, String, X1, Y1> src, InstExp<String, String, X2, Y2> dst, List<Pair<LocStr, String>> files,
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder().append("import_stream ").append(src).append(" -> ").append(dst)
        .append(" {\n\t").append(Util.sep(map, " -> ", "\n\t"));
  ...
  public boolean equals(Object obj) {
    return (obj instanceof TransExpStream) && super.equals(obj);
  }
  ...
  protected Map<String, List<String[]>> start(Schema<String, String, Sym, Fk, Att> sch) throws Exception {
    ...
    Map<String, List<String[]>> ret = InstExpStream.start2(map2, op, sch, false);
    return ret;
  }
